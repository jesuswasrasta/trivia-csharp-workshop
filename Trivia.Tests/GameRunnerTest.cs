...
public class GameRunnerTests
{
    ...
    [Test(Description = "Riesco a lanciare GameRunner")]
    public void RiescoALanciareGameRunner()
    {
...
";
    ...
    [Test(Description = "Riesco a lanciare GameRunner passandogli un random noto a priori")]
    public void RiescoALanciareGameRunnerConRandomNoto()
    {
        var stringWriter = new StringWriter();
        Console.SetOut(stringWriter);

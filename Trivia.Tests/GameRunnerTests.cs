...
public class GameRunnerTests
{
    ...
    public void PossoLanciareGameRunner()
    {
        var args = new []{""};
    ...
    [Test(Description = "Posso intercettare i messaggi che GameRunner spara in console")]
    public void PossoIntercettareMessaggiGameRunner()
    {
...
";
    ...
    [Test(Description = "Posso iniettare Random in GameRunner")]
    public void PossoIniettareRandomInGameRunner()
    {
        var stringWriter = new StringWriter();
        Console.SetOut(stringWriter);
